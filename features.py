# features.py
# Aggregates transaction data and merges features to the customer table

import pandas as pd

def aggregate_transactions(df_customers, df_transactions):
    # For big data, aggregate only on existing transactions
    ...
    # Main spending category: for individuals use their category, others use top_category
    ...
    # Example "product interest" tag: total_amount > 50k and tx_category_count > 8
